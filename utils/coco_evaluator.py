...
class CocoEvaluator(object):
    def __init__(self, coco_gt, iou_types, nb_keypoints=24):
        ...
        for iou_type in iou_types:
            ...
            if iou_type == 'keypoints':
              self.coco_eval[iou_type].params.kpt_oks_sigmas = np.array([0.05]*nb_keypoints)
